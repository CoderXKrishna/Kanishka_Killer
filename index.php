...
$botToken = "7113760555:AAG59H6UxtswOt8i-MzfGTXR16hLmKYpDxc";
...
$emojid = '❌';
$emojil = '❌';
$owner = '<code>@MANISHOPGAMING</code>';
$cofuid = '1212';
$cofuid2 = '1212';
$cofuid3 = '1212';
#FIN DE LA CAPTURA
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "Owner 🧑‍💻", 'url' => "https://t.me/ManishCardingStore"],
            ['text' => "BUY 💰", 'url' => "https://t.me/MANISHOPGAMING"],
        ],
    ]
]);
...
if ($cdata2 == "premium") {
   $premiumText = "<b>\n𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗚𝗔𝗧𝗘𝗦 🌟 ⇢ \n\n╔═════════════════╗\n
  ├𝑮𝒂𝒕𝒆𝒘𝒂𝒚 : 𝚂𝚝𝚛𝚒𝚙𝚎 𝙰𝚄𝚃𝙷 1$ ❌ 
  ├𝑼𝒔𝒆𝒓 : 𝗙𝗥𝗘𝗘   
  ├𝑼𝒔𝒂𝒈𝒆 : /au 𝒄𝒄|𝒎𝒎|𝒆𝒙𝒑|𝒄𝒗𝒗 \n
  ├<u>𝑮𝒂𝒕𝒆𝒘𝒂𝒚</u> : 𝚂𝚀 𝙰𝚄𝚃𝙷 3$ ❌ 
  ├𝑼𝒔𝒆𝒓 : 𝗣𝗥𝗘𝗠𝗜𝗨𝗠  
  ├𝑼𝒔𝒂𝒈𝒆 : /b3 𝒄𝒄|𝒎𝒎|𝒆𝒙𝒑|𝒄𝒗𝒗 \n
  ├<u>𝑮𝒂𝒕𝒆𝒘𝒂𝒚</u> : 𝙰𝚢𝚗𝙺𝚘 $1 ❌
  ├𝑼𝒔𝒆𝒓 : 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 
  ├Usage : /lol cc|mm|exp|cvv \n
  ├<u>𝑮𝒂𝒕𝒆𝒘𝒂𝒚</u> : 𝙱𝚛𝚊𝚒𝚗𝚝𝚛𝚎𝚎 𝙰𝚄𝚃𝙷 ❌
  ├𝑼𝒔𝒆𝒓 : 𝗣𝗥𝗘𝗠𝗜𝗨𝗠  
  ├𝑼𝒔𝒂𝒈𝒆 : /sex 𝒄𝒄|𝒎𝒎|𝒆𝒙𝒑|𝒄𝒗𝒗 \n
  ├<u>𝑮𝒂𝒕𝒆𝒘𝒂𝒚</u> : 𝚂𝚝𝚛𝚒𝚙𝚎 𝙲𝙷𝙰ʀ𝙶𝙴 ❌
  ├𝑼𝒔𝒆𝒓 : 𝗣𝗥𝗘𝗠𝗜𝗨𝗠  
  ├𝑼𝒔𝒂𝒈𝒆 : /chk 𝒄𝒄|𝒎𝒎|𝒆𝒙𝒑|𝒄𝒗𝒗 \n
  ├<u>𝑮𝒂𝒕𝒆𝒘𝒂𝒚</u> : 𝙿𝚊𝚢𝙵𝚕𝚘𝚠 𝙰𝚅𝚂 ❌ 
  ├𝑼𝒔𝒆𝒓 : 𝗣𝗥𝗘𝗠𝗜𝗨𝗠  
  ├𝑼𝒔𝒂𝒈𝒆 : /sau 𝒄𝒄|𝒎𝒎|𝒆𝒙𝒑|𝒄𝒗𝒗 \n
  ├<u>𝑮𝒂𝒕𝒆𝒘𝒂𝒚</u> : 𝙲𝙲𝙽 𝙲𝙷𝙰ʀ𝙶𝙴 0.7$ ❌
  ├𝑼𝒔𝒆𝒓 : 𝗣𝗥𝗘𝗠𝗜𝗨𝗠  
  ├𝑼𝒔𝒂𝒈𝒆 : /lee 𝒄𝒄|𝒎𝒎|𝒆𝒙𝒑|𝒄𝒗𝒗 \n
  ├<u>𝑮𝒂𝒕𝒆𝒘𝒂𝒚</u> : 𝚂𝚝𝚛𝚒𝚙𝚎 𝙲𝙷𝙰ʀ𝙶𝙴 1$ ❌ 
  ├𝑼𝒔𝒆𝒓 : 𝗣𝗥𝗘𝗠𝗜𝗨𝗠  
...
//=============PRICE===============//
if ($cdata2 == "price") {
    $priceText = "<b>\n" . str_repeat(' ', 20) . "『 𝑷𝒓𝒊𝒄𝒆 💸』" . str_repeat(' ', 20) . "\n╔═════════════════╗\n •├3 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 2$\n •├7 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 4$\n •├15 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 7$\n •├30 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 12$\n╚═════════════════╝\n •├Dev ➳ <code>@MANISHOPGAMING</code>\n━━━━━━━━━━━━━━━━━━━</b>";

    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => '𝑯𝑶𝑴𝑬', 'callback_data' => 'back2'], ['text' => '𝑩𝑼𝒀', 'url' => 'https://t.me/MANISHOPGAMING']]
        ]
    ]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝗚𝗿𝗼𝘂𝗽 ", 'url' => "https://t.me/ManishCardingStore"], ['text' => "𝗖𝗵𝗮𝗻𝗻𝗲𝗹", 'url' => "https://t.me/ManishCardingStore"]],
        [['text' => "𝗕𝗔𝗖𝗞 ", 'callback_data' => 'back2']]
    ]
]);
...
𝑬𝒙𝒑𝒍𝒐𝒓𝒆 𝒎𝒆 𝒎𝒐𝒓𝒆 𝒃𝒚 𝒄𝒍𝒊𝒄𝒌𝒊𝒏𝒈 𝒕𝒉𝒆 𝒃𝒖𝒕𝒕𝒐𝒏𝒔 𝒃𝒆𝒍𝒐𝒘</b>");
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/Itsz_Manish/2"; 
