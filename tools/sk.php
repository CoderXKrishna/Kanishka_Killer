<?php
if ((strpos($message, "/sk") === 0)||(strpos($message, "sk_Dead_") === 0)||(strpos($message, ".sk") === 0))
{
...
elseif(strpos($stripe1, 'Your account cannot currently make Dead charges.'))
{
  $skmsg=urlencode("<b>
[↯] 𝗗𝗘𝗔𝗗 𝗞𝗘𝗬 ❌
...
[↯] 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 : Your account cannot currently make Dead charges.
